...
{cc.bgreen}[{cc.white}1{cc.bgreen}] - {cc.white}Criar CPF falso

{cc.bgreen}[{cc.white}2{cc.bgreen}] - {cc.white}Criar CEP falso

{cc.bgreen}[{cc.white}3{cc.bgreen}] - {cc.white}Criar CNPJ falso

{cc.bgreen}[{cc.white}4{cc.bgreen}] - {cc.white}Criar E-MAIL falso

{cc.bgreen}[{cc.white}5{cc.bgreen}] - {cc.white}Criar IP aleatório

{cc.bgreen}[{cc.white}6{cc.bgreen}] - {cc.white}Informações

{cc.bgreen}[{cc.white}7{cc.bgreen}] - {cc.white}Sair\n""")
